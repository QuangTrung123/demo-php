        ...
        <div class="panel-body">
            ...
            <form method="post" enctype="multipart/form-data" action="<?php echo $action; ?>">
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-10">
                        <input type="number" value="<?php echo isset($record->amount)?$record->amount:""; ?>" name="amount" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:5px;">
                    ...
                    <div class="col-md-10">
                        <input type="number" value="<?php echo isset($record->input_price)?$record->input_price:""; ?>" name="input_price" class="form-control" required>
                    </div>
                </div>
