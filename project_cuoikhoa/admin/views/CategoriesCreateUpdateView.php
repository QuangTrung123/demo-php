                ...
                <div class="col-md-10">
                    <select name="parent_id" class="form-control" style="width:300px;">
                        ...
                        <?php 
                         ...
                         <option <?php if(isset($record->parent_id)&&$record->parent_id==$rows->id&&$record->parent_id==$rows->parent_id): ?> selected <?php endif; ?> value="<?php echo ($rows->id); ?>"><?php echo $rows->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
