        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="personal-infomation">
              <form class="primari-box personal-info-box" id="personalinfo" method="post" action="index.php?controller=account&action=registerPost">
                ...
                <div class="personal-info-content">
                  ...
                  <div class="submit-button p-info-submit-button">
                    <input type="submit" class="btn btn-danger" style="font-size: 20px;" value="Register">
