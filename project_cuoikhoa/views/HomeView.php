                        ...
                        <div class="new-product">
                          <div class="single-product-item">
                            <div class="product-image">
                              <a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><img src="assets/upload/products/<?php echo $rows->photo; ?>" alt="<?php echo $rows->name; ?>" /></a>
                            ...
                            <div class="product-info">
                              ...
                              <div class="price-box ">
                                <span class="price"><?php echo number_format($rows->price - ($rows->price*$rows->discount)/100); ?></span>
                ...
                <div class="col-xs-12">
                  <div class="row">
                    ...
                    <div class="sale-carousel">
                      <?php 
                        $hotProduct = $this->modelSaleProduct();
                       ?>
                       <?php foreach($hotProduct as $rows): ?>
                      ...
                      <div class="item">
                        <div class="new-product">
                          <div class="single-product-item">
                            <div class="product-image">
                              <a href="index.php?controller=products&action=detail&id=<?php echo $rows->id; ?>"><img src="assets/upload/products/<?php echo $rows->photo; ?>" alt="<?php echo $rows->name; ?>" /></a>
                              <a href="#" class="new-mark-box"><?php echo ($rows->discount); ?>%</a>
                              <div class="overlay-content">
                                <ul>
                                  <li><a href="index.php?controller=cart&action=create&id=<?php echo $rows->id; ?>" title="Quick view"><i class="fa fa-search"></i></a></li>
                                  <li><a href="index.php?controller=cart&action=create&id=<?php echo $rows->id; ?>" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
                                  <li><a href="index.php?controller=cart&action=create&id=<?php echo $rows->id; ?>" title="Quick view"><i class="fa fa-retweet"></i></a></li>
                                  <li><a href="index.php?controller=cart&action=create&id=<?php echo $rows->id; ?>" title="Quick view"><i class="fa fa-heart-o"></i></a></li>
                                </ul>
                              </div>
                            </div>
                            <div class="product-info">
          ...
          <div class="add-two-by-one-column">
            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
              <div class="tow-column-add zoom-img">
                <a href="#"><img src="vendors/img/product/shope-add1.jpg" alt="shope-add" /></a>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
              <div class="one-column-add zoom-img">
                <a href="#"><img src="vendors/img/product/shope-add2.jpg" alt="shope-add" /></a>
              </div>                
            </div>
          </div>
            ...
            <div class="tab-bg-product-area">
              ...
              <div class="tab-carousel-menu">
                <ul class="nav nav-tabs product-bg-nav">
                  <li class="active"><a href="#women-tab" data-toggle="tab">all</a></li> <?php 
                    //lay cac danh muc co hienthitrangchu=1
                    $homeeCategory = $this->modelCategoryDisplayHome();
                   ?>
                   <?php foreach($homeeCategory as $rowssHome): ?>
                  <li><a href="#tops-tab" data-toggle="tab"><?php echo $rowssHome->name; ?></a></li>
                  <?php endforeach; ?>
                </ul>
              </div>
          ...
          <div class="image-add-area">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="onehalf-add-shope zoom-img">
                <a href="#"><img src="vendors/img/product/one-helf1.jpg" alt="shope-add" /></a>
              </div>
              <!-- ONEHALF-ADD END -->
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <!-- ONEHALF-ADD START -->
              <div class="onehalf-add-shope zoom-img">
                <a href="#"><img src="vendors/img/product/one-helf2.jpg" alt="shope-add" /></a>
              </div>
              <!-- ONEHALF-ADD END -->
            </div>            
          </div>
              ...
              <div class="row">
                ...
                <div class="latest-news-carousel">
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/1.jpg" alt="latest-post" /></a>
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/2.jpg" alt="latest-post" /></a>
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/3.jpg" alt="latest-post" /></a>
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/4.jpg" alt="latest-post" /></a>
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/5.jpg" alt="latest-post" /></a>
                  ...
                  <div class="item">
                    <div class="latest-news-post">
                      <div class="single-latest-post">
                        <a href="#"><img src="vendors/img/latest-news/6.jpg" alt="latest-post" /></a>
