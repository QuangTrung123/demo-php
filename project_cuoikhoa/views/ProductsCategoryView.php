                ...
                <ul class="pagination-bar">
                  <li class="disabled">
                    ...
                    <?php for($i = 1; $i <= $numPage; $i++): ?>
                      <li>
                        <span><a class="pagi-num" href="index.php?controller=products&action=categories&catid=<?php echo $category_id; ?>&p=<?php echo $i; ?>&order=nameAsc"><?php echo $i; ?></a></span>
                      </li>
                    <?php endfor; ?>
                ...
                <div class="row">
                  <ul class="gategory-product">
                    ...
                    <?php foreach($data as $rows): ?>
                      <li class="gategory-product-list col-lg-4 col-md-4 col-sm-6 col-xs-12" style="float: left!important;">
